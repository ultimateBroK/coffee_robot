...
void startAnimation() {
    ...
    robot.animationProgress = 0.0f;
    printf("\n=== BAT DAU QUY TRINH PHA CAFE ===\n");
    printf("Giai doan 1: Vuon tay toi lay coc.\n");
}

// Reset robot về trạng thái ban đầu
void resetRobot() {
    initRobot();
    printf("\nRobot da duoc reset ve vi tri ban dau. Nhan SPACE de bat dau lai.\n");
}
    ...
    switch (robot.currentPhase) {
        case PHASE_REACH_CUP:
            ...
            if (robot.animationProgress >= 1.0f) {
                ...
                printf("Giai doan 2: Kep va nhac coc.\n");
            }
            break;
        ...
        case PHASE_GRAB_CUP:
            ...
            if (robot.animationProgress >= 1.0f) {
                ...
                robot.animationProgress = 0.0f;
                printf("Giai doan 3: Xoay nguoi ve phia may pha ca phe.\n");
            }
            break;
        ...
        case PHASE_TURN_TO_MACHINE:
            ...
            if (robot.animationProgress >= 1.0f) {
                ...
                robot.animationProgress = 0.0f;
                printf("Giai doan 4: Dat coc vao voi va rot ca phe.\n");
            }
            break;
        ...
        case PHASE_POUR_COFFEE:
            ...
            if (robot.animationProgress >= 1.5f) {
                ...
                printf("Giai doan 5: Quay tro lai vi tri ban dau.\n");
            }
            break;
        ...
        case PHASE_RETURN_CUP:
            ...
            if (robot.animationProgress >= 1.0f) {
                ...
                robot.animationProgress = 0.0f;
                printf("Giai doan 6: Dat coc xuong ban.\n");
            }
            break;
        ...
        case PHASE_RETRACT:
            ...
            if (robot.animationProgress >= 1.0f) {
                ...
                robot.isAnimating = false;
                printf("=== HOAN THANH! Ca phe cua ban da san sang. ===\n");
            }
            break;
